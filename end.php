...
//Deletes post from SQL database
   ...
   if (empty($errors)) {
	...
	$sql = "UPDATE story_list SET end = 1 WHERE id = " . $_GET['s'] . "";
...
<body>
    ...
    <div class="content-section-a" style="min-height:100%;margin-bottom:-150px;">
        ...
        <div class="container">
			<h2 class="section-heading">Are you sure you want to permanently end this story?</h2><hr>
			<form action = "" method = "post"> 
			<input type='submit' value="End Story" class="btn btn-danger">
			</form>
			<?php
			echo "<a href='story.php" . "?s=" . $_GET['s'] . "'>Nevermind</a>";
			?>
        </div>
        <!-- /.container -->
